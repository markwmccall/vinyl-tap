...
class TestParseTagData:
    def test_valid_album_tag(self):
        from core.nfc_interface import parse_tag_data
...
class TestParseNdefText:
    def test_returns_none_for_empty_bytes(self):
        from core.nfc_interface import _parse_ndef_text
    ...
    def test_parses_text_record(self):
        from core.nfc_interface import _parse_ndef_text, _build_ndef_text_tlv
...
class TestBuildNdefTextTlv:
    def test_starts_with_ndef_tlv_type(self):
        from core.nfc_interface import _build_ndef_text_tlv
    ...
    def test_round_trip(self):
        from core.nfc_interface import _build_ndef_text_tlv, _parse_ndef_text
...
class TestPN532NFC:
    def _make_nfc(self, mock_pn532):
        ...
        from core.nfc_interface import PN532NFC
